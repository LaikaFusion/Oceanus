...
const animals = {
    acanthoscinaAcanthodes: {
        ...
        img: `${baseURL}/img/crustaceans/img/amphipods/acanthoscinaAcanthodes/acanthoscina-acanthodes.png`
    },
    amphithyrusBispinosus: {
        ...
        img: `${baseURL}/img/crustaceans/img/amphipods/amphithyrusBispinosus/amphithyrus-bispinosus.png`
    },
    anapronoeReinhardti: {
        id: 3,
        name: `Anapronoe reinhardti`,
        description: `Length 5-6 mm (Anapronoe reinhardti 1). With characters of genus Anapronoe.`,
        img: `${baseURL}/img/crustaceans/img/amphipods/anapronoeReinhardti/anapronoe-reinhardti.png`
    },
    anchylomeraBlossevillei: {
        ...
        img: `${baseURL}/img/crustaceans/img/amphipods/anchylomeraBlossevillei/anchylomera-blossevillei.png`
    },
    andaniexisAustralis: {
        id: 5,
        ...
        img: `${baseURL}/img/crustaceans/img/amphipods/andaniexisAustralis/andaniexis-australis.png`
    },
    archaeoscinaSteenstrupi: {
        ...
        img: `${baseURL}/img/crustaceans/img/amphipods/archaeoscinaSteenstrupi/archaeoscina-steenstrupi.png`
    },
    bathystegocephalusGlobosus: {
        ...
        img: `${baseURL}/img/crustaceans/img/amphipods/bathystegocephalusGlobosus/bathystegocephalus-globosus.png`
    },
    calamorhynchusPellucidus: {
        ...
        img: `${baseURL}/img/crustaceans/img/amphipods/calamorhynchusPellucidus/calamorhynchus-pellucidus.png`
    },
    cranocephalusScleroticus: {
        ...
        img: `${baseURL}/img/crustaceans/img/amphipods/cranocephalusScleroticus/cranocephalus-scleroticus.png`
    },
    ctenoscinaBrevicaudata: {
        ...
        img: `${baseURL}/img/crustaceans/img/amphipods/ctenoscinaBrevicaudata/ctenoscina-brevicaudata.png`
    },
    cyllopusLucasi: {
        id: 11,
        ...
        img: `${baseURL}/img/crustaceans/img/amphipods/cyllopusLucasi/cyllopus-lucasi.png`
    },
    cyphocarisAnonyx: {
        id: 12,
        ...
        img: `${baseURL}/img/crustaceans/img/amphipods/cyphocarisAnonyx/cyphocaris-anonyx.png`
    },
    cyphocarisChallengeri: {
        ...
        img: `${baseURL}/img/crustaceans/img/amphipods/cyphocarisChallengeri/cyphocaris-challengeri.png`
    },
    cystisomaFabricii: {
        id: 14,
        ...
        img: `${baseURL}/img/crustaceans/img/amphipods/cystisomaFabricii/cystisoma-fabricii.png`
    },
    cystisomaLongipes: {
        id: 15,
        ...
        img: `${baseURL}/img/crustaceans/img/amphipods/cystisomaLongipes/cystisoma-longipes.png`
    },
    cystisomaMagna: {
        id: 16,
        ...
        img: `${baseURL}/img/crustaceans/img/amphipods/cystisomaMagna/cystisoma-magna.png`
    }
};
