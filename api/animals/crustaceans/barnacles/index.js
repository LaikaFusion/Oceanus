...
const animals = {
    ribbedBarnacle: {
        ...
        distribution: `Common`,
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/barnacles/ribbedBarnacle/ribbed-barnacle.png`
    },
    smoothGooseNeckBarnacle: {
        ...
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/barnacles/smoothGooseNeckBarnacle/smooth-goose-neck-barnacle.png`
    }
};
