...
const animals = {
    aesopSlipperLobster: {
        ...
        habitat: `Known from depths between 10 and 135 m. Probably on rocky bottom.`,
        ...
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/crabsAndLobsters/aesopSlipperLobster/aesop-slipper-lobster.jpg`
    },
    africanSpearLobster: {
        id: 2,
        ...
        habitat: `Depth range from 216 to 375; on rough substrate with sand and mud.`,
        ...
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/crabsAndLobsters/africanSpearLobster/african-spear-lobster.png`
    },
    americanBlunthornLobster: {
        ...
        habitat: `The species has been taken in depths between 120 and 298 m, but there is a record from the littoral zone, and one from 4111-4122 m. The bottom is variously described as "sand and coral", "sandy calcarenite", and "smooth, consisting of brown mud ".`,
        ...
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/crabsAndLobsters/americanBlunthornLobster/american-blunthorn-lobster.jpg`
    },
    americanLobster: {
        id: 4,
        ...
        habitat: `Sublittoral to 480 m depth, most common between 4 and 50 m Hard bottom (hard mud, rocks). As the females carry their eggs for 10 to 11 months, ovigerous females are found throughout the year. Migration does not occur" or only on a limited scale.`,
        ...
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/crabsAndLobsters/americanLobster/american-lobster.jpg`
    },
    americanSpiderCrab: {
        id: 5,
        ...
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/crabsAndLobsters/americanSpiderCrab/american-spider-crab.jpg`
    },
    andamanLobster: {
        id: 6,
        ...
        habitat: `Depth range from 250 to 750 m, but mostly between 300 and 450 m. Substrate of hard mud; the species possibly lives in burrows`,
        ...
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/crabsAndLobsters/andamanLobster/andaman-lobster.png`
    },
    arabianWhipLobster: {
        id: 7,
        ...
        habitat: `Known from depths between 180 and 1300 m, most common between 180 and 300 m; on a substrate of coarse sand, hard mud and shells.`,
        ...
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/crabsAndLobsters/arabianWhipLobster/arabian-whip-lobster.jpg`
    },
    arafuraLobster: {
        id: 8,
        ...
        habitat: `Found at 560 m depth; bottom solid bluish grey mud overlaid by softer brown mud.`,
        ...
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/crabsAndLobsters/arafuraLobster/arafura-lobster.png`
    },
    armouredLobster: {
        id: 9,
        ...
        habitat: `At depths of 200 to 450 m, mostly more than 300 m. On a more rocky bottom than the other Taiwan lobsters.`,
        ...
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/crabsAndLobsters/armouredLobster/armoured-lobster.jpg`
    },
    atlanticDeepSeaLobster: {
        ...
        habitat: `A deep-sea species from 293 to 878 m depth (mostly between 550 and 825 m). Lives on soft mud bottoms in burrows.`,
        ...
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/crabsAndLobsters/atlanticDeepSeaLobster/atlantic-deep-sea-lobster.png`
    },
    atlanticPincerLobster: {
        ...
        habitat: `Deep-sea species from 640 to 1054 m depth. Bottom very flat, of soft mud (ooze). Possibly a burrowing species.`,
        ...
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/crabsAndLobsters/atlanticPincerLobster/atlantic-pincer-lobster.jpg`
    },
    australianGhostShrimp: {
        ...
        habitat: `On intertidal sand- or mud-flats, often in or near estuaries. The animals burrow in the soft substratum.`,
        ...
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/crabsAndLobsters/australianGhostShrimp/australian-ghost-shrimp.jpg`
    },
    australianPincerLobster: {
        ...
        habitat: `Taken at a depth of 425 m.`,
        ...
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/crabsAndLobsters/australianPincerLobster/australian-pincer-lobster.jpg`
    },
    australianSpinyLobster: {
        ...
        color: `pale to dark purplish brown. Abdomen with widely scattered small pale spots, which sometimes are hardly noticeable. Antennulae uniform in colour or with a pale longitudinal streak. Legs pale or dark brown with longitudinal streaks.`,
        ...
        habitat: `Found in depths between 0 and 90 m, rarely as deep as 120 m. The animals are nocturnal and shelter in the daytime in rock crevices and among coral. They undertake limited migrations. The species is omnivorous.`,
        ...
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/crabsAndLobsters/australianSpinyLobster/australian-spiny-lobster.jpg`
    },
    bandedLobster: {
        id: 15,
        ...
        habitat: `Depth range between (393-) 451 and 550 m Substrate: mud.`,
        ...
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/crabsAndLobsters/bandedLobster/banded-lobster.jpg`
    },
    bandedSpinyLobster: {
        id: 16,
        ...
        color: `carapace with yellowish, reddish and brownish colour, not spotted. Abdomen bright to dark purple with a conspicuous transverse yellow band over the middle of each somite. Legs rather uniform in colour, with a few spots, but not streaked. Antennulae rather uniform in colour.`,
        ...
        habitat: `The species has been reported from depths down to 143 m, but usually in shallow water, in well protected places on a rocky substrate, under rocks and in rock crevices. The animals are nocturnal.`,
        ...
        img: `${process.env.BASE_ROUTE}/img/crustaceans/img/crabsAndLobsters/bandedSpinyLobster/banded-spiny-lobster.jpg`
    } 
};
